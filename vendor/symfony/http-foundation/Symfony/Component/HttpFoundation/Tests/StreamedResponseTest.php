...
class StreamedResponseTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPrepareWith11Protocol()
    {
        ...
        $this->assertNotEquals('chunked', $response->headers->get('Transfer-Encoding'), 'Apache assumes responses with a Transfer-Encoding header.css set to chunked to already be encoded.');
