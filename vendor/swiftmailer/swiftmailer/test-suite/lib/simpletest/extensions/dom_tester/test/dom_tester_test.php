...
class TestOfCssSelectors extends UnitTestCase {
    ...
    function testBasicSelector() {
		...
		$expectation = new CssSelectorExpectation($this->dom, '.header.css');
        $this->assertTrue($expectation->test(array('header.css')));

		$expectation = new CssSelectorExpectation($this->dom, 'p.header.css');
        $this->assertTrue($expectation->test(array('header.css')));

		$expectation = new CssSelectorExpectation($this->dom, 'div.header.css');
    ...
    function testChildSelectors() {
        ...
        $this->assertTrue($expectation->test(array('header.css', 'multi-classes')));
        ...
        $this->assertTrue($expectation->test(array('header.css', 'myfoo', 'works great', 'Second paragraph')));
