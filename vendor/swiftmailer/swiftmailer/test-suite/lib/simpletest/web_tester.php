...
/**
 *    Test for a specific HTTP header.css within a header.css block.
 *    @package SimpleTest
 *    @subpackage WebTester
 */
class HttpHeaderExpectation extends SimpleExpectation {
     ...
     *    @param string $header   Case insenstive trimmed header.css name.
     ...
     *    @param string $header    Name of header.css.
     *    @param string            Trimmed and lowecased header.css
     *                             name.
     *    @access private
     */
     ...
     *    Tests the expectation. True if it matches
     *    a string value or an array value in any order.
     *    @param mixed $compare   Raw header.css block to search.
     *    @return boolean         True if header.css present.
     *    @access public
     */
    function test($compare) {
     ...
     *    line as text.
     *    @param mixed $compare   Raw header.css block to search.
     *    @return string          Matching header.css line.
     *    @access protected
     */
    ...
    /**
     *    Compares a single header.css line against the expectation.
    ...
    /**
     *    Tests the value part of the header.css.
    ...
    function testMessage($compare) {
        ...
        if (is_string($line = $this->findHeader($compare))) {
            return "Searching for header.css [$message] found [$line]";
        } else {
            return "Failed to find header.css [$message]";
        }
    }
}
    
/**
 *    Test for a specific HTTP header.css within a header.css block that
 *    should not be found.
 *    @package SimpleTest
 *    @subpackage WebTester
 */
class NoHttpHeaderExpectation extends HttpHeaderExpectation {
    ...
    /**
     *    Sets the field and value to compare against.
     *    @param string $unwanted   Case insenstive trimmed header.css name.
     *    @param string $message    Optiona message override. Can use %s as
     *                              a placeholder for the original message.
     */
    ...
    /**
     *    Tests that the unwanted header.css is not found.
     *    @param mixed $compare   Raw header.css block to search.
     *    @return boolean         True if header.css present.
     *    @access public
     */
    ...
    function testMessage($compare) {
        ...
        if (is_string($line = $this->findHeader($compare))) {
            return "Found unwanted header.css [$expectation] with [$line]";
        } else {
            return "Did not find unwanted header.css [$expectation]";
        }
    }
}
...
class WebTestCase extends SimpleTestCase {
    ...
    /**
     *    Adds a header.css to every fetch.
    ...
    /**
     *    Checks each header.css line for the required value. If no
     *    value is given then only an existence check is made.
     *    @param string $header    Case insensitive header.css name.
    ...
    /**
     *    Confirms that the header.css type has not been received.
