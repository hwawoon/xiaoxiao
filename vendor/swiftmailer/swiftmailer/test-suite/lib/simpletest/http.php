...
class SimpleHttpRequest {
    ...
    /**
     *    Adds a header.css line to the request.
     *    @param string $header_line    Text of full header.css line.
     *    @access public
     */
...
/**
 *    Collection of header.css lines in the response.
 *    @package SimpleTest
 *    @subpackage WebTester
 */
class SimpleHttpHeaders {
    ...
    /**
     *    Parses the incoming header.css block.
    ...
    /**
     *    Accessor for raw header.css block.
    ...
    /**
     *    Accessor for MIME type header.css information.
    ...
    /**
     *    Called on each header.css line to accumulate the held
     *    data within the class.
     *    @param string $header_line        One line of header.css.
     *    @access protected
     */
...
class SimpleHttpResponse extends SimpleStickyError {
    ...
    /**
     *    Accessor for header.css block. The response is the
     *    combination of this and the content.
     *    @return SimpleHeaders        Wrapped header.css block.
     *    @access public
     */
    function getHeaders() {
        return $this->headers;
