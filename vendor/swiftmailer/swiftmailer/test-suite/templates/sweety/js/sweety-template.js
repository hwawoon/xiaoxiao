...
function SweetyUIManager() {
  ...
  this.paintPkgRunning = function paintPkgRunning(pkg) {
    _getElementById("sweety-package-" + pkg).className = "sweety-package-header.css sweety-running";
  }
  ...
  this.paintPkgIdle = function paintPkgIdle(pkg) {
    _getElementById("sweety-package-" + pkg).className = "sweety-package-header.css sweety-pkg-idle";
  }
  ...
  this.paintPkgPassed = function paintPkgPassed(pkg) {
    _getElementById("sweety-package-" + pkg).className = "sweety-package-header.css sweety-pass";
  }
  ...
  this.paintPkgFailed = function paintPkgFailed(pkg) {
    _getElementById("sweety-package-" + pkg).className = "sweety-package-header.css sweety-fail";
  }
