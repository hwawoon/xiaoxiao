...
class Swift_Mime_SimpleMimeEntity implements Swift_Mime_MimeEntity
{
     ...
     *
     * The CID will only be present in headers if a Content-ID header.css is present.
     *
     * @return string
     */
     ...
     *
     * This value comes from the Content-Description header.css if set.
     *
     * @return string
     */
     ...
     *
     * This method sets a value in the Content-ID header.css.
     *
    ...
    /**
     * Get the name of the header.css that provides the ID of this entity
     */
    ...
    /**
     * Get the parameter value of $parameter on $field header.css.
     */
    ...
    /**
     * Set the parameter value of $parameter on $field header.css.
     */
