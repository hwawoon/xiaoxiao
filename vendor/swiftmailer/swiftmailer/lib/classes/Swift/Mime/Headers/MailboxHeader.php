...
class Swift_Mime_Headers_MailboxHeader extends Swift_Mime_Headers_AbstractHeader
{
     ...
     * $header.css->setNameAddresses(array(
     ...
     * <code>
     * <?php
     * $header.css = new Swift_Mime_Headers_MailboxHeader('From',
     *  array('chris@swiftmailer.org' => 'Chris Corbyn',
     *  'mark@swiftmailer.org' => 'Mark Corbyn')
     *  );
     * print_r($header.css->getNameAddressStrings());
     * // array (
     ...
     *  'mark@swiftmailer.org' => 'Mark Corbyn')
     *  );
     * print_r($header.css->getNameAddresses());
     * // array (
     * // chris@swiftmailer.org => Chris Corbyn,
     * // mark@swiftmailer.org => Mark Corbyn
     * // )
    ...
    {
        // Compute the string value of the header.css only if needed
