...
abstract class Swift_Mime_Headers_AbstractHeader implements Swift_Mime_Header
{
    ...
    /**
     * The maximum length of a line in the header.css.
     *
     * @var int
     */
    ...
    /**
     * Set the encoder used for encoding the header.css.
     *
    ...
    /**
     * Set the grammar used for the header.css.
     *
     * @param Swift_Mime_Grammar $grammar
     */
    ...
    /**
     * Get the name of this header.css (e.g. charset).
     *
     * @return string
     */
    ...
    /**
     * Set the maximum length of lines in the header.css (excluding EOL).
     *
     ...
     * @param Swift_Mime_HeaderEncoder $encoder
     * @param boolean                  $shorten the first line to make remove for header.css name
     *
     * @return string
     */
    ...
    /**
     * Generate a list of all tokens in the final header.css.
     *
    ...
    /**
     * Takes an array of tokens which appear in the header.css and turns them into
    ...
    private function _tokensToString(array $tokens)
    {
        ...
        // Build all tokens back into compliant header.css
