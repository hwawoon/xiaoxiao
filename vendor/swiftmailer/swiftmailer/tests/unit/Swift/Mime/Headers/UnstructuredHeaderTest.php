    ...
    extends Swift_Tests_SwiftUnitTestCase
{
    ...
    {
        /* -- RFC 2822, 2.2.3
        Each header.css field is logically a single line of characters comprising
        the field name, the colon, and the field body.  For convenience
        however, and to deal with the 998/78 character limitations per line,
        the field body portion of a header.css field can be split into a multiple
     ...
     scary brown fox with a bushy tail
        */
        $this->assertEqual(
            ...
            ' very very' . "\r\n" . //Folding
            ' scary brown fox with a bushy tail' . "\r\n",
            $header->toString(), '%s: The header.css should have been folded at 78th char'
            );
    }
    ...
    public function testEncodedWordsAreNoMoreThan75CharsPerLine()
    {
        ...
        While there is no limit to the length of a multiple-line header.css
        field, each line of a header.css field that contains one or more
    ...
    public function testAdjacentWordsAreEncodedTogether()
    {
     ...
     same header.css field.  However, an 'encoded-word' that appears in a
     header.css field defined as '*text' MUST be separated from any adjacent
    ...
    public function testLanguageInformationAppearsInEncodedWords()
    {
        ...
        message header.css comments, phrases, and any unstructured text field.
