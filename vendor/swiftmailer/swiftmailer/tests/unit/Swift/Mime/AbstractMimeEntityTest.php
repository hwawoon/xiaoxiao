    ...
    extends Swift_Tests_SwiftUnitTestCase
{
    ...
    public function testIdIsReturnedFromHeader()
    {
        ...
        labelled using the "Content-ID" header.css field, which is syntactically
        identical to the "Message-ID" header.css field
        */
    ...
    public function testDescriptionIsReadFromHeader()
    {
        ...
        may be placed in the Content-Description header.css field.  This header.css
